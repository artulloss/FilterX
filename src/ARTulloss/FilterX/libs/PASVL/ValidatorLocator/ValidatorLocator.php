...
namespace ARTulloss\FilterX\libs\PASVL\ValidatorLocator;

use ARTulloss\FilterX\libs\PASVL\Validator\Validator;
...
class ValidatorLocator
{
    ...
    protected function locateDefault(string $name): ?Validator
    {
        ...
        $fqcn = "\\ARTulloss\\FilterX\\libs\\PASVL\\Validator\\" . ucfirst($name) . "Validator";
